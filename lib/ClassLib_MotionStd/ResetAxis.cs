...
{
    public class ResetAxis : AbsResetAxis
    {
        public ResetAxis(AbsAxis myAxis)
        {
            _myAxis = myAxis;
        }
        protected ResetAxis() { }

        override public bool GoHome()
        {
        ...
        /// <returns></returns>
        override public bool ZGoHome(double vel = AbsMotion.ConstDebugVel, double acc = 1000, double velLow = AbsMotion.ConstDebugVel / 100, double accLow = 10, double offsetZero = 0, int timeOut = 10)
        {
            double offset = 1;
        ...
        /// <returns></returns>
        override public bool GoHomeZByLimit(double vel = AbsMotion.ConstDebugVel, double acc = AbsMotion.ConstDebugAcc, double offset = 5, double velLow = AbsMotion.ConstDebugVel / 100, double accLow = 10, double offsetLow = 1, double offsetZero = 1, bool bRotation = false, bool bNegateResetDirection = false, int bTimeOut = 10)
        {
        ...
        /// <param name="bTimeOut"></param>
        /// <returns></returns>
        override public bool GoHomeByLimit(double vel = AbsMotion.ConstDebugVel, double acc = AbsMotion.ConstDebugAcc, double offset = 5, double velLow = AbsMotion.ConstDebugVel / 100, double accLow = 10, double offsetLow = 1, double offsetZero = 1, bool bRotation = false, bool bNegateResetDirection = false, int bTimeOut = 10)
        {
            int iOffsetDir = (bNegateResetDirection) ? -1 : 1;
            short sRtn = 0;
            _myAxis.ZeroPos();
